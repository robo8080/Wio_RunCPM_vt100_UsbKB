...
#define NORM_MARGINH_X  0         // マージン文字数 (横)
#define NORM_MARGINH_Y  0         // マージン文字数 (縦)
// 縦画面時: (40 or 30 - NORM_MARGINV_X) x (40 - NORM_MARGINV_Y)
#define NORM_MARGINV_X  0         // マージン文字数 (横)
#define NORM_MARGINV_Y  0         // マージン文字数 (縦)
...
#define WIDE_MARGINH_Y  0         // マージン文字数 (縦)
// 縦画面時: (60 - WIDE_MARGINV_X) x (40 - WIDE_MARGINV_Y)
#define WIDE_MARGINV_X  0         // マージン文字数 (横)
#define WIDE_MARGINV_Y  0         // マージン文字数 (縦)
